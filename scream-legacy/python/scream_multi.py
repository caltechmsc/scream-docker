...
Usage: %s <bgffile> <rotlib_specs> <ff> <selections> <residue list>
E.g.:  %s PheRS.bgf 05 10 F258_A F260_A
...
FF: suggestion: /app/lib/ff/dreiding-0.3.par
...
#    ff_file           = SCREAM_NEW+'/lib/ff/dreiding-0.3.par'
    ...
    multi_placement   = 'ExcitationWithClustering'
    ...
    print >>SCREAM_PAR_FILE, '%25s %s' % ('Selections',                  selections)
